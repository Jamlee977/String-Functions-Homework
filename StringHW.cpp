 ...
 * @return int 
 */
int substring(char __TOCOPYIN[], char __TOBECOPIED[], unsigned int __START, unsigned int __END) {
 ...
 * @return int 
 */
int at(char __ARRAYOFCHAR[], unsigned int __INDEX, char __INSERTEDCHAR) {
